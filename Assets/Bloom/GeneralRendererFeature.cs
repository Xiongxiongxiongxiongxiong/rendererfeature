...
public class GeneralRendererFeature : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    GeneralRenderPass generalPass;

    class GeneralRenderPass : ScriptableRenderPass
    {
        ...
        public GeneralRenderPass(Material material)
        {
    ...
    {
        generalPass = new GeneralRenderPass(settings.bloomMaterial);
        //{
